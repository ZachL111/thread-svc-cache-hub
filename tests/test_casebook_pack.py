"""Regression checks for the thread-svc-cache-hub casebook."""
...
from casebook.harness import assert_expected, thread_svc_cache_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_svc_cache_hub_summary(), assert_expected())
